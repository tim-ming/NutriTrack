...
fun ForgotPasswordVerifyScreen(
    ...
    ForgotPasswordVerifyContent(
        ...
        onBackClick = viewModel::onVerifyScreenBackClick,
    )
}

@Composable
fun ForgotPasswordVerifyContent(
    innerPadding: PaddingValues,
    ...
    Box(
        ...
        Column(
            ...
            TopBackButton(onBackClick, "Login")
            ...
            Column(
                ...
                Text(
                    "To reset your password, confirm your identity with your User ID and phone number.",
